...
import type { MonthlyWithdrawalReasonStat } from '@/features/admin/types/adminApi'
...
export default function WithdrawalReasonTrendChart({ data }: WithdrawalReasonTrendChartProps) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6">
      ...
      {isEmpty ? (
        <p className="py-12 text-center text-sm text-gray-400">탈퇴 데이터가 쌓이면 월별 추세가 표시됩니다</p>
      ) : (
