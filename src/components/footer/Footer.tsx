      ...
      <div className={cn(PAGE_CONTAINER, 'py-12')}>
        <div className="flex flex-wrap justify-baseline gap-x-10 gap-y-5 md:justify-between md:gap-0">
          ...
          <nav aria-label="푸터 링크" className="flex flex-wrap gap-x-10 gap-y-5">
            ...
            {/* 안내 문서는 여기 나란히 둔다. 지금 셋(이용약관·개인정보처리방침·계정 삭제
                안내)이라 목차 페이지를 두면 한 번 더 눌러야 닿는다.

                ⚠️ 이용약관은 **여기 있어야 한다.** 전자상거래법 제10조 제1항이 사이버몰
                운영자에게 사업자 신원정보와 **이용약관을 초기화면에 표시**하도록 정한다
                (연결 화면으로 갈음할 수 있다). 2025년 3월 당근마켓이 이 조항을 어겨
                시정명령과 과태료를 받았다. 지우거나 더 깊이 묻지 말 것.

                ⚠️ 항목이 다섯을 넘어가면 그때 「도움말 센터」(/help) 목차 페이지를
                만들고 이 문서들을 그 하위로 옮긴다. 앞으로 생길 만한 것들:
                운영정책(금지 행위·제재 기준) · 안전거래 안내 · 자주 묻는 질문 ·
                공지사항 · 청소년보호정책.
