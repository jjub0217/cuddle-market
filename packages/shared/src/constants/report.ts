 ...
 *
 * 그중 상품은 이제 실제로 걸러진다 — 백엔드 상품 검색 쿼리에서 차단한 판매자를
 * 뺐다(cmarket_api, 2026-08-02). 그래서 그 줄만 되살렸다.
 *
 * **커뮤니티 글과 프로필은 아직 안 숨겨진다.** 그 줄은 그대로 뺀 채 둔다.
 * 되살리려면 백엔드가 커뮤니티 조회에서도 차단을 봐야 한다.
 *
